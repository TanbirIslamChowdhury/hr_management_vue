            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <!-- <div class="nav-item dropdown">
                        <a href="#" class="nav-link " data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Clients</a>
                    ...
                    <router-link to="/employee" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Employee</router-link>
                    ...
                    <!-- <router-link to="/message" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Messages</router-link>
                     ...
                     <router-link to="/favourite" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Favourites</router-link>

                     <router-link to="/report" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Reports</router-link> -->
